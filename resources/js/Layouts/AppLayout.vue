            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            >
                                <NavLink
                                    :href="route('recruitment-request')"
                                    :active="
                                        route().current('recruitment-request')
                                    "
                                >
                                    Recruitment
                                </NavLink>
                                <NavLink
                                    :href="route('talent-pool')"
                                    :active="route().current('talent-pool')"
                                >
                                    Talent pool
                                </NavLink>
                            </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="ms-3 relative flex items-center gap-2">
                                <a-dropdown :placement="'bottomRight'">
                                    <a-button
                                        type="ghost"
                                        class="flex items-center justify-center text-xs text-gray-700"
                                    >
                                        <template #icon>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <a-menu>
                                            ...
                                            <a-menu-item>
                                                <a-button type="ghost" class="flex items-center justify-between w-full p-0 gap-4">
                                                    ...
                                                    <div class="flex-1 text-[var(--admin-menu-text)] font-medium text-left">Interviewer</div>
                                                </a-button>
                                            </a-menu-item>
                                            <a-menu-item>
                                                <a-button type="ghost" class="flex items-center justify-between w-full p-0 gap-4">
                                                    ...
                                                    <div class="flex-1 text-[var(--admin-menu-text)] font-medium text-left">System Data</div>
                                                </a-button>
                                            </a-menu-item>
                                    ...
                                    <template #trigger>
                                        ...
                                        >
                                            ...
                                            >
                                                <a-button
                                                    type="ghost"
                                                    class="p-0 mr-1 flex items-center my-auto"
                                                >
                                                    <Icon
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink
                            :href="route('recruitment-request')"
                            :active="route().current('recruitment-request')"
                        >
                            Recruitment
                        </ResponsiveNavLink>
                    </div>
